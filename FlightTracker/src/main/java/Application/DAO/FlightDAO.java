...
public class FlightDAO {
    ...
    public Flight insertFlight(Flight flight){
        ...
        try {
            ...
            String sql = "insert into flights (depature_city, arrival_city (?, ?);" ;
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city){
        ...
        try {
            //Write SQL logic here
            String sql = "select * from flights depature_city = ? and arrival_city = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);

            //write PreparedStatement setString and setInt methods here.
            preparedStatement.setString(1,"depature_city");
            preparedStatement.setString(1,"arrival_city");
            preparedStatement.setInt(2,123);
